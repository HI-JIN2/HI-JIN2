...
### Project
 - [EAT-SSU(잇슈, 숭실대 학식 리뷰 앱)](https://github.com/EAT-SSU/Android) - 안드로이드 개발, 총괄 리드 <sub>(2022.11 ~ )</sub><br>
 - [마니또 파티(마니또 배정 이메일 전송 서비스)](https://github.com/HI-JIN2/manitto-backend) - 웹 풀스택 1인 개발 및 운영 <sub>(2025.03 ~ 2025.06)</sub><br>
 - [새길(북한이탈주민 정착지원 서비스)](https://github.com/saegil-project/Saegil-Android) - 안드로이드 개발, 팀장 <sub>(2025.03 ~ 2025.06)</sub><br>
<br>

### Experience
- GDSC Soongsil 3, 4기 (2023.10 ~ 2025.08)
- Pre-startup COGO (2024.08 ~ 2024.12)
...
- GDSC 2024 대학 연합 해커톤 눈꽃톤 최우수상(2위) <sub>(GDSC 대학 연합, 2024.01)</sub><br>
